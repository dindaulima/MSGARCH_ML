...
##### end of Essential section for MSGARCH-SVR process #####
...
head(data)
result.SVR.MSGARCH.rt.window5 = fitSVR(data, startTrain, endTrain, endTest, tune_C=tune_C, tune_eps=tune_eps, tune_gamma=tune_gamma)
...
head(data)
result.SVR.MSGARCH.at.window5 = fitSVR(data, startTrain, endTrain, endTest, tune_C=tune_C, tune_eps=tune_eps, tune_gamma=tune_gamma)
